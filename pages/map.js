...
const markerMouseOut=useCallback(()=>{
    ...
    return (
        <TopLayout>
        <MapWrapper>
            <div style={{position:'absolute',zIndex:100,marginTop:60,marginLeft:10}}>
                      ...
                      <>
                        ...
                        //   onLoad={handle}
                         ...
                         {showOverLay&&<OverlayView
                          ...
                          >
                              <div style={{ textAlign:'center', position:'relative', bottom:100, right:20}}>
...
{componentContent&&<div>
    <div ><img style={{width:350}}   src={componentContent.image[0].url}></img></div>
    <div  ><p style={{width:100,marginLeft:'auto',marginTop:10}}>{componentContent.createdAt}</p></div>
    <div style={{marginTop:20,marginLeft:20}}><h1>{componentContent.name}</h1></div>
    <div style={{marginTop:20,marginLeft:20}} ><h3>{componentContent.reward} 원</h3></div>
    <div style={{marginTop:20,marginLeft:20}} ><h3>{componentContent.tradeType.direct?'직거래가능':'직거래불가'}</h3></div>
    <div style={{marginTop:20,marginLeft:20}} ><h3>{componentContent.tradeType.delivery?'택배거래가능':'택배거래불가'}</h3></div>


    <div style={{marginTop:25,textAlign:'center'}} ><h2>{componentContent.content}</h2></div>

    <Button type='primary' style={ {
        marginLeft:65, width:200 ,marginTop:20, borderRadius:20,height:40}}>채팅하기</Button>
    </div>}
{/* {items.map((item)=>(
